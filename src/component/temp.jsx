...
const Footer = () => {
    return (
        <>
            <div className='bg-[#254A33] text-white flex flex-col items-center h-[50rem]'>
                <div className='pt-4'>
                ...
                <div className='mt-6'>
                    <img src={wave6} className='w-full h-auto' alt='Wave' />
                    <div className='bg-[#FFB30B] text-white flex items-center px-40 justify-evenly'>
                        <div className='mr-52'>
                        ...
                        <div className='bg-[#FFB30B] flex items-center justify-center flex-col p-11'>
                                ...
                                <div>
                                    ...
                                    <div className='flex items-center gap-4'>
                                        ...
                                        <div>
                                            <p>BRANCH 1:</p>
                                            <p>
                                                Near Lancohills circle, Sri Laxmi Nagar Colony, Manikonda, Hyderabad, Telangana 500089</p>
                                        </div>
